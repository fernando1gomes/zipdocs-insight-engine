...
export const PILLAR_DEFAULTS: Pillar[] = [
  { id: 1, name: "Contribuição e legado", shortName: "Contribuição", icon: "🤝", score: 7.0, message: "Equilíbrio, crescer", impact: 3, impactPillars: ["Emocional", "Profissional", "Social"] },
  { id: 2, name: "Emocional", shortName: "Emocional", icon: "❤️", score: 4.8, message: "Crítico, acolher emoções", impact: 3, impactPillars: ["Saúde", "Relacionamento", "Profissional"] },
  { id: 3, name: "Família", shortName: "Família", icon: "👨‍👩‍👧‍👦", score: 8.1, message: "Equilibrado, conectar", impact: 3, impactPillars: ["Emocional", "Saúde", "Lazer"] },
  { id: 4, name: "Relacionamento amoroso", shortName: "Relacionamento", icon: "💕", score: 6.6, message: "Atenção, fortalecer diálogo", impact: 3, impactPillars: ["Emocional", "Lazer", "Comunicação"] },
  { id: 5, name: "Social e amizades", shortName: "Social", icon: "👥", score: 7.4, message: "Equilibrado, cultivar", impact: 3, impactPillars: ["Emocional", "Saúde", "Lazer"] },
  { id: 6, name: "Profissional e carreira", shortName: "Carreira", icon: "💼", score: 8.5, message: "Equilibrado, prosperar", impact: 4, impactPillars: ["Financeiro", "Saúde", "Emocional", "Familiar"], focus: true },
